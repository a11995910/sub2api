...
// 递增版本，淘汰缺少定制计费字段和上游分组策略的旧认证快照。
const apiKeyAuthSnapshotVersion = 28
...
func (s *APIKeyService) snapshotFromAPIKey(ctx context.Context, apiKey *APIKey) *APIKeyAuthSnapshot {
	...
	if apiKey.Group != nil {
		snapshot.Group = &APIKeyAuthGroupSnapshot{
			...
			CacheHitTargetTolerancePercent:  apiKey.Group.CacheHitTargetTolerancePercent,
			CacheHitHalfLifeDays:            apiKey.Group.CacheHitHalfLifeDays,
			...
			PromoDiscountStart:              apiKey.Group.PromoDiscountStart,
			PromoDiscountEnd:                apiKey.Group.PromoDiscountEnd,
			PromoDiscountRate:               apiKey.Group.PromoDiscountRate,
...
func (s *APIKeyService) snapshotToAPIKey(key string, snapshot *APIKeyAuthSnapshot) *APIKey {
	...
	if snapshot.Group != nil {
		...
		apiKey.Group = &Group{
			...
			CacheHitTargetTolerancePercent:  snapshot.Group.CacheHitTargetTolerancePercent,
			CacheHitHalfLifeDays:            snapshot.Group.CacheHitHalfLifeDays,
			...
			PromoDiscountEnabled:            snapshot.Group.PromoDiscountEnabled,
			PromoDiscountStart:              snapshot.Group.PromoDiscountStart,
			PromoDiscountEnd:                snapshot.Group.PromoDiscountEnd,
			PromoDiscountRate:               snapshot.Group.PromoDiscountRate,
