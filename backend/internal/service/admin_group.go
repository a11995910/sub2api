...
func (s *adminServiceImpl) DeleteGroup(ctx context.Context, id int64, replacementGroupID *int64) error {
	return s.deleteGroup(ctx, id, false, replacementGroupID)
}

func (s *adminServiceImpl) DeleteGroupIfEmpty(ctx context.Context, id int64) error {
	return s.deleteGroup(ctx, id, true, nil)
}

func (s *adminServiceImpl) deleteGroup(ctx context.Context, id int64, requireEmpty bool, replacementGroupID *int64) error {
	if s.cfg != nil && s.cfg.RunMode == config.RunModeSimple {
		group, err := s.groupRepo.GetByIDLite(ctx, id)
		if err != nil {
			return err
