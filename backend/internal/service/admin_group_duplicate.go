...
func cloneGroupForDuplicate(source *Group, operationID string) *Group {
	return &Group{
		...
		PromoDiscountEnabled:            source.PromoDiscountEnabled,
		PromoDiscountStart:              cloneGroupValuePointer(source.PromoDiscountStart),
		PromoDiscountEnd:                cloneGroupValuePointer(source.PromoDiscountEnd),
		PromoDiscountRate:               source.PromoDiscountRate,
		...
		CacheHitHalfLifeDays:            source.CacheHitHalfLifeDays,
		...
		AutoFallbackGroupID:             cloneGroupValuePointer(source.AutoFallbackGroupID),
