...
func SetupRouter(
	...
	modelTestAuth middleware2.ModelTestAuthMiddleware,
	...
	r.Use(middleware2.ResponseCompression())
	...
	// 注册路由
	registerRoutes(r, handlers, jwtAuth, optionalJWTAuth, adminAuth, apiKeyAuth, modelTestAuth, auditLog, stepUpAuth, apiKeyService, subscriptionService, opsService, settingService, compositeResolver, cfg, redisClient)
...
func registerRoutes(
	...
	routes.RegisterGatewayRoutes(r, h, apiKeyAuth, modelTestAuth, apiKeyService, subscriptionService, opsService, settingService, compositeResolver, cfg)
