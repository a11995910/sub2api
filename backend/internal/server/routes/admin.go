...
func registerGroupRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	groups := admin.Group("/groups")
	{
		...
		groups.GET("/:id/allowed-users", h.Admin.Group.GetGroupAllowedUsers)
...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers, stepUpAuth middleware.StepUpAuthMiddleware) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.GET("/:id/healthy-turn-state", h.Admin.Account.GetHealthyTurnState)
		accounts.GET("/:id/healthy-turn-state/models", h.Admin.Account.GetHealthyTurnStateModels)
		accounts.GET("/:id/healthy-turn-state/dynamic/config", h.Admin.Account.GetHealthyTurnStateDynamicConfig)
		accounts.PUT("/:id/healthy-turn-state/dynamic/config", h.Admin.Account.SaveHealthyTurnStateDynamicConfig)
		accounts.POST("/:id/healthy-turn-state/dynamic/runs", h.Admin.Account.StartHealthyTurnStateDynamic)
		accounts.POST("/:id/healthy-turn-state/dynamic/runs/:run_id/step", h.Admin.Account.StepHealthyTurnStateDynamic)
		accounts.POST("/:id/healthy-turn-state/dynamic/runs/:run_id/stop", h.Admin.Account.StopHealthyTurnStateDynamic)
