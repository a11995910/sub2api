...
func modelPricingTimePricingRow(timePricing any) *sqlmock.Rows {
	return sqlmock.NewRows(channelModelPricingTimePricingColumns).AddRow(
		...
		service.PriceCurrencyCNY, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, timePricing,
	...
	t.Run("create writes JSON", func(t *testing.T) {
		...
		mock.ExpectQuery(regexp.QuoteMeta("INSERT INTO channel_model_pricing (channel_id, platform, models, billing_mode, price_currency, input_price, output_price, cache_write_price, cache_write_1h_price, cache_read_price, fast_multiplier, flex_multiplier, max_reasoning_effort_multiplier, image_input_price, image_output_price, per_request_price, time_pricing)")).
			WithArgs(
				...
				service.PriceCurrencyCNY, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, channelModelPricingTimePricingJSON,
			).
	...
	t.Run("update writes JSON and entry ID", func(t *testing.T) {
		...
		mock.ExpectExec(`(?s)UPDATE channel_model_pricing.*per_request_price = \$14, time_pricing = \$15, platform = \$16.*WHERE id = \$17`).
			WithArgs(
				...
				service.PriceCurrencyCNY, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, channelModelPricingTimePricingJSON, "openai", int64(11),
			).
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			t.Run("create writes SQL NULL", func(t *testing.T) {
				...
				mock.ExpectQuery(regexp.QuoteMeta("INSERT INTO channel_model_pricing (channel_id, platform, models, billing_mode, price_currency, input_price, output_price, cache_write_price, cache_write_1h_price, cache_read_price, fast_multiplier, flex_multiplier, max_reasoning_effort_multiplier, image_input_price, image_output_price, per_request_price, time_pricing)")).
					WithArgs(
						int64(7), "openai", []byte(`["gpt-5"]`), service.BillingModeToken,
						service.PriceCurrencyUSD, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil,
					).
					WillReturnRows(sqlmock.NewRows([]string{"id", "created_at", "updated_at"}).AddRow(int64(11), time.Time{}, time.Time{}))
			...
			t.Run("update writes SQL NULL", func(t *testing.T) {
				...
				mock.ExpectExec(`(?s)UPDATE channel_model_pricing.*per_request_price = \$14, time_pricing = \$15, platform = \$16.*WHERE id = \$17`).
					WithArgs(
						[]byte(`["gpt-5"]`), service.BillingModeToken,
						service.PriceCurrencyUSD, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, "openai", int64(11),
					).
					WillReturnResult(sqlmock.NewResult(0, 1))
