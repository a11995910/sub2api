...
var migrationChecksumCompatibilityRules = map[string]migrationChecksumCompatibilityRule{
	...
	// 195 最初写入 mode=v2，后改为安全默认值 v1 并让 v2 变为主动启用。
	// 已经应用 v2 初始值的数据库保留原记录和历史校验和。
	...
	// 220 最初清理所有非 Grok 平台的视频价格，之后先保留 composite，
	// 再因本仓库支持 OpenAI 视频而保留 OpenAI。
	"220_clear_non_grok_video_generation_config.sql": newMigrationChecksumCompatibilityRule("ac1d0871abc1da7da863c8e1db851ea085a7b5f25e68df05def3b11d722d3105", "85e320b9ec64f2d3fcd8cf705b2b4e76a7b49f7a57140c14bff97f32691c818b", "3da48c8fdffe6390325f43d08b8e353e0a365df43d44a78dbbe655d0deb18402"),
