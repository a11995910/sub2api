...
func APIKeyFromService(k *service.APIKey) *APIKey {
	...
	out := &APIKey{
		...
		GroupID:               k.GroupID,
		Status:                k.Status,
		OpenAIFastModeEnabled: k.OpenAIFastModeEnabled,
...
func usageLogFromServiceUser(l *service.UsageLog) UsageLog {
	...
	return UsageLog{
		...
		UpstreamResponseServiceTier: l.UpstreamResponseServiceTier,
...
// 仅向普通用户追加 OAuth 真实账号标识，不返回内部账号 ID 或管理员自定义名称。
func UsageLogFromServiceForUser(l *service.UsageLog, userID int64) *UsageLog {
	...
	identifier := service.ResolveOAuthAccountDisplayIdentifier(l.Account)
	if identifier != "" {
		out.OAuthAccount = &OAuthAccountInfo{Identifier: identifier}
	}
	return out
}
...
func UsageLogFromServiceAdmin(l *service.UsageLog) *AdminUsageLog {
	...
	return &AdminUsageLog{
		...
		CacheHitOriginalInputTokens:       l.CacheHitOriginalInputTokens,
		CacheHitOriginalCacheReadTokens:   l.CacheHitOriginalCacheReadTokens,
		CacheHitShiftedTokens:             l.CacheHitShiftedTokens,
		CacheHitTargetPercent:             l.CacheHitTargetPercent,
		CacheHitTargetTolerancePercent:    l.CacheHitTargetTolerancePercent,
		CacheHitCumulativePromptTokens:    l.CacheHitCumulativePromptTokens,
		CacheHitCumulativeCacheReadTokens: l.CacheHitCumulativeCacheReadTokens,
		CacheHitCumulativePercent:         l.CacheHitCumulativePercent,
		CacheHitStateVersion:              l.CacheHitStateVersion,
