...
type CreateAPIKeyRequest struct {
	...
	OpenAIFastModeEnabled    bool     `json:"openai_fast_mode_enabled"`    // OpenAI 请求未带 service_tier 时默认补 priority
	AutoGroupFallbackEnabled *bool    `json:"auto_group_fallback_enabled"` // nil 时使用服务端默认值 true
...
type UpdateAPIKeyRequest struct {
	...
	OpenAIFastModeEnabled    *bool     `json:"openai_fast_mode_enabled"`    // nil=不变；非 nil 时更新 OpenAI fast 默认补齐开关
	AutoGroupFallbackEnabled *bool     `json:"auto_group_fallback_enabled"` // nil=不变；非 nil 时更新自动承接开关
...
func (h *APIKeyHandler) Create(c *gin.Context) {
	...
	svcReq := service.CreateAPIKeyRequest{
		...
		AutoGroupFallbackEnabled: req.AutoGroupFallbackEnabled,
