...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		OpenAICodexTicketModelMismatchInvalidation:             settings.OpenAICodexTicketModelMismatchInvalidation,
		OpenAICodexTicketUseHarvestProxy:                       settings.OpenAICodexTicketUseHarvestProxy,
		...
		OpenAICodexTicketHarvestExtractURL:                     service.MaskOpenAICodexTicketHarvestExtractURL(settings.OpenAICodexTicketHarvestExtractURL),
		OpenAICodexTicketHarvestExtractConfigured:              strings.TrimSpace(settings.OpenAICodexTicketHarvestExtractURL) != "",
		OpenAICodexTicketHarvestExtractProtocol:                settings.OpenAICodexTicketHarvestExtractProtocol,
