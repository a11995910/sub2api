...
func init() {
	...
	groupDescImageSuperResolutionEnabled := groupFields[12].Descriptor()
	...
	groupDescImage2kEnhancementEnabled := groupFields[13].Descriptor()
	...
	groupDescImage4kEnhancementEnabled := groupFields[15].Descriptor()
	...
	groupDescImage4kEnhancementModel := groupFields[17].Descriptor()
	...
	groupDescCacheHitQuarterToInputEnabled := groupFields[19].Descriptor()
