...
func init() {
	...
	groupDescImageResponseFormat := groupFields[17].Descriptor()
	...
	groupDescImageSuperResolutionEnabled := groupFields[18].Descriptor()
	...
	groupDescImage2kEnhancementEnabled := groupFields[19].Descriptor()
	...
	groupDescImage4kEnhancementEnabled := groupFields[21].Descriptor()
	...
	groupDescImage4kEnhancementModel := groupFields[23].Descriptor()
	...
	groupDescCacheHitQuarterToInputEnabled := groupFields[26].Descriptor()
	...
	groupDescImageRateMultiplier := groupFields[27].Descriptor()
	...
	groupDescBatchImageDiscountMultiplier := groupFields[31].Descriptor()
	...
	groupDescBatchImageHoldMultiplier := groupFields[32].Descriptor()
	...
	groupDescVideoRateIndependent := groupFields[33].Descriptor()
	...
	groupDescVideoRateMultiplier := groupFields[34].Descriptor()
