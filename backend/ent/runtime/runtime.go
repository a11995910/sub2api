...
func init() {
	...
	groupDescAllowBatchImageGeneration := groupFields[22].Descriptor()
	...
	groupDescImageRateIndependent := groupFields[23].Descriptor()
	...
	groupDescCacheHitQuarterToInputEnabled := groupFields[24].Descriptor()
