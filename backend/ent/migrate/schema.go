...
var (
	...
	APIKeysColumns = []*schema.Column{
		...
		{Name: "openai_fast_mode_enabled", Type: field.TypeBool, Default: false},
		{Name: "auto_group_fallback_enabled", Type: field.TypeBool, Default: true},
	...
	GroupsColumns = []*schema.Column{
		...
		{Name: "image_4k_enhancement_model", Type: field.TypeString, Nullable: true, Size: 100},
		...
		{Name: "auto_fallback_group_id", Type: field.TypeInt64, Nullable: true},
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "cache_hit_original_input_tokens", Type: field.TypeInt, Default: 0},
		{Name: "cache_hit_original_cache_read_tokens", Type: field.TypeInt, Default: 0},
		{Name: "cache_hit_shifted_tokens", Type: field.TypeInt, Default: 0},
		{Name: "cache_hit_target_percent", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(5,2)"}},
		{Name: "cache_hit_target_tolerance_percent", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(5,2)"}},
		{Name: "cache_hit_cumulative_prompt_tokens", Type: field.TypeInt64, Default: 0},
		{Name: "cache_hit_cumulative_cache_read_tokens", Type: field.TypeInt64, Default: 0},
		{Name: "cache_hit_cumulative_percent", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(7,4)"}},
		{Name: "cache_hit_state_version", Type: field.TypeInt64, Default: 0},
