...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	videoTestTaskHandler := handler.NewVideoTestTaskHandler(videoTestTaskService, videoTestTaskGateway)
	...
	videoTestTaskCleanupService := service.ProvideVideoTestTaskCleanupService(videoTestTaskStore)
