...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, usageHandler, oAuthAccountPoolHandler, redeemHandler, subscriptionHandler, announcementHandler, channelMonitorUserHandler, checkinHandler, creativeDrawingHandler, adminHandlers, gatewayHandler, openAIGatewayHandler, handlerSettingHandler, totpHandler, handlerPaymentHandler, paymentWebhookHandler, availableChannelHandler, asyncImageHandler, batchImageHandler, generatedImageHandler, videoTestTaskHandler, idempotencyCoordinator, idempotencyCleanupService, generatedImageCleanupService, videoTestTaskCleanupService)
