...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    path: '/beginner-guide',
    name: 'BeginnerGuide',
    component: () => import('@/views/public/BeginnerGuideView.vue'),
    meta: {
      requiresAuth: false,
      title: '小白使用攻略'
    }
...
const BACKEND_MODE_ALLOWED_PATHS = ['/login', '/key-usage', '/beginner-guide', '/developer-docs', '/setup', '/payment/result', '/payment/airwallex', '/legal']
...
router.beforeEach(async (to, _from, next) => {
  ...
  if (
    (to.meta.requiresPayment || to.meta.requiresRiskControl || to.meta.requiresLottery || to.meta.requiresSubscription) &&
