...
describe('AdminPaymentPlansView', () => {
  ...
  it('uses spirit stones while preserving the configured currency label', async () => {
    ...
    expect(wrapper.text()).toContain('499.00 灵石CNY')
    expect(wrapper.text()).toContain('599.00 灵石')
    expect(wrapper.text()).toContain('10.00 灵石')
  })
})
