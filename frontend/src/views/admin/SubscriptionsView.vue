            ...
            <div class="min-w-[280px] space-y-2">
              ...
              <div v-if="row.group?.daily_limit_usd" class="usage-row">
                <div class="flex items-center gap-2">
                  ...
                  <span class="usage-amount">
                    {{ formatQuotaAmount(row.daily_usage_usd) }}
                    <span class="text-gray-400">/</span>
                    {{ formatQuotaAmount(row.group?.daily_limit_usd) }}
                  </span>
                </div>
              ...
              <div v-if="row.group?.weekly_limit_usd" class="usage-row">
                <div class="flex items-center gap-2">
                  ...
                  <span class="usage-amount">
                    {{ formatQuotaAmount(row.weekly_usage_usd) }}
                    <span class="text-gray-400">/</span>
                    {{ formatQuotaAmount(row.group?.weekly_limit_usd) }}
                  </span>
                </div>
              ...
              <div v-if="row.group?.monthly_limit_usd" class="usage-row">
                <div class="flex items-center gap-2">
                  ...
                  <span class="usage-amount">
                    {{ formatQuotaAmount(row.monthly_usage_usd) }}
                    <span class="text-gray-400">/</span>
                    {{ formatQuotaAmount(row.group?.monthly_limit_usd) }}
                  </span>
                </div>
...
const formatQuotaAmount = (value: number | null | undefined): string => {
  return formatSpiritStones(value ?? 0)
}
