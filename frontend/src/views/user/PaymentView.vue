        ...
        <template v-else>
          ...
          <template v-if="activeTab === 'recharge'">
            ...
            <div class="card p-5">
              ...
              <p class="mt-0.5 text-sm font-medium text-green-600 dark:text-green-400">{{ t('payment.currentBalance') }}: {{ formatSpiritStones(user?.balance || 0) }}</p>
            </div>
            ...
            <div v-if="validAmount > 0" class="card p-6">
              <div class="space-y-2 text-sm">
                ...
                <div v-if="balanceRechargeMultiplier !== 1" class="flex justify-between" :class="{ 'border-t border-gray-200 pt-2 dark:border-dark-600': feeRate <= 0 }">
                  ...
                  <span class="text-gray-900 dark:text-white">{{ formatSpiritStones(creditedAmount) }}</span>
                </div>
              ...
              <div class="card p-5">
                ...
                <div class="mt-3 grid grid-cols-2 gap-3">
                  ...
                  <div v-if="selectedPlan.daily_limit_usd != null">
                    ...
                    <div class="text-lg font-semibold text-gray-800 dark:text-gray-200">{{ formatSpiritStones(selectedPlan.daily_limit_usd) }}</div>
                  </div>
                  <div v-if="selectedPlan.weekly_limit_usd != null">
                    <span class="text-xs text-gray-400 dark:text-gray-500">{{ t('payment.planCard.weeklyLimit') }}</span>
                    <div class="text-lg font-semibold text-gray-800 dark:text-gray-200">{{ formatSpiritStones(selectedPlan.weekly_limit_usd) }}</div>
                  </div>
                  <div v-if="selectedPlan.monthly_limit_usd != null">
                    <span class="text-xs text-gray-400 dark:text-gray-500">{{ t('payment.planCard.monthlyLimit') }}</span>
                    <div class="text-lg font-semibold text-gray-800 dark:text-gray-200">{{ formatSpiritStones(selectedPlan.monthly_limit_usd) }}</div>
                  </div>
