export default {
  common: {
    ...
    promoRateChip: 'LIMITED',
    promoDiscountLabel: '{off}% off',
    promoRateTooltip: 'Limited-time offer {discount}, window {window} (server timezone {tz})',
    save: 'Save',
  ...
  nav: {
    ...
    usage: 'Usage',
    videoTaskReviews: 'Abnormal Video Tasks',
    redeem: 'Redeem',
