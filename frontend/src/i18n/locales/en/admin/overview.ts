export default {
    ...
    affiliates: {
      ...
      withdraw: {
        ...
        amount: 'Withdrawal amount (Spirit Stones)',
    ...
    groups: {
      ...
      groupBaseRate: 'Group base rate',
      promoGroupEffectiveRate: 'Promotional group rate',
      userBaseRate: 'User base rate',
      promoEffectiveRate: 'Promotional effective rate',
      promoRateAppliedHint: 'Promotion active: user-specific rates are billed at {discount}. Promotion window: {window}.',
      ...
      batchAdjustedRate: 'Batch-adjusted rate',
