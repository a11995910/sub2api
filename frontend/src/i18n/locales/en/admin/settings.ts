export default {
    settings: {
      ...
      gatewayForwarding: {
        ...
        codexTicketEnabled: 'Upstream 292 ticket collection',
        codexTicketEnabledDesc: 'Applies to accounts using the upstream 292 ticket strategy. Collects tickets in the background and injects them into requests. Healthy-header strategies use their own controls.',
        codexTicketHarvestMode: '292 ticket collection source',
        codexTicketHarvestModeProxy: 'Fixed proxy URL',
        codexTicketHarvestModeExtract: 'Batch IP extraction API',
        codexTicketHarvestModeHint: 'Used only for ticket collection. Business requests keep using the account proxy. Switching sources preserves the other source settings.',
        codexTicketHarvestProxy: '292 ticket collection proxy',
        codexTicketHarvestProxyDesc: 'Enter a complete HTTP(S) or SOCKS5(h) proxy URL. IP rotation is handled by the provider. Leave blank or keep the masked password to preserve the saved value.',
