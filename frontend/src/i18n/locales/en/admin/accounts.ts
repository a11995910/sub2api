export default {
    accounts: {
      ...
      openai: {
        ...
        healthyTurnStateRecordDesc: 'On by default. Save this account’s turn state in memory after the first meaningful Responses output, for up to 40 minutes. Restarting clears it. Turning this off stops collection; existing records expire normally.',
        ...
        testModelPlaceholder: 'Leave blank for the default test model',
