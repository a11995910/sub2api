export default {
    accounts: {
      ...
      openai: {
        ...
        healthyTurnStateReplaceDesc: 'Off by default. On an HTTP or WebSocket handshake 429/503, retry once with a saved state from the shared OpenAI pool, regardless of account, model, transport or proxy. Discard it if the retry fails. Respects upstream retry delays; effectiveness is unverified and rate limits may persist.',
        stateStats: {
