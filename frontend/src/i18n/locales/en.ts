  ...
  admin: {
    ...
    groups: {
      ...
      imagePricing: {
        ...
        image2KEnhancementHint: 'When this group receives an explicit 2K image request, the generated image is upscaled locally to 2K (no other group is called and no extra billing).',
        image4KEnhancement: '4K enhancement',
        image4KEnhancementHint: 'When this group receives a 4K image request, generate the base image first, then enhance it through a target image group using the original size.',
        image4KEnhancementGroup: '4K enhancement target group',
        selectImage4KEnhancementGroup: 'Select image group',
        noImage4KEnhancementGroup: 'Do not use a 4K enhancement group',
        image4KEnhancementGroupHint: 'The target must be an OpenAI image group. Select a target model after selecting the group.',
        image4KEnhancementGroupRequired: 'Select a target image group when 4K enhancement is enabled',
