  ...
  admin: {
    ...
    groups: {
      ...
      imagePricing: {
        ...
        image2KEnhancementHint: 'When this group receives an explicit 2K image request, generate the base image first, then upscale it through a target image group using the original size.',
        image2KEnhancementGroup: '2K super-resolution target group',
        selectImage2KEnhancementGroup: 'Select image group',
        noImage2KEnhancementGroup: 'Do not use a 2K super-resolution group',
        image2KEnhancementGroupHint: 'The target must be an OpenAI image group. The original request size is passed through unchanged; after 3 target failures, the base image is returned.',
        image2KEnhancementGroupRequired: 'Select a target image group when 2K super resolution is enabled',
        ...
        image4KEnhancementGroupHint: 'The target must be an OpenAI image group. The original request size is passed through unchanged; after 3 target failures, the base image is returned.',
