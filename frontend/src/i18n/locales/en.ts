export default {
  ...
  keys: {
    ...
    openaiFastMode: 'OpenAI Fast Mode',
    ...
    quotaAmount: 'Quota Amount (Spirit Stones)',
    quotaAmountPlaceholder: 'Enter quota limit in Spirit Stones',
    ...
    resetUsage: 'Reset',
    rateLimit5h: '5-Hour Limit (Spirit Stones)',
    rateLimit1d: 'Daily Limit (Spirit Stones)',
    rateLimit7d: '7-Day Limit (Spirit Stones)',
  ...
  oauthAccountPool: {
    ...
    overviewDescription: 'See plans, quota, and live runtime status at a glance.',
  ...
  usage: {
    ...
    cacheHitControlDetails: 'Cache Hit Rate Control',
    cacheHitOriginalInputTokens: 'Original input',
    cacheHitOriginalCacheReadTokens: 'Original cache read',
    cacheHitShiftedTokens: 'Moved to input',
    cacheHitTarget: 'Target and tolerance',
    cacheHitCumulative: 'Adjusted cumulative hit rate',
    cacheHitStateVersion: 'State generation',
  ...
  availableChannels: {
    ...
    imageRateTooltip: 'Final image-generation multiplier: {rate}x',
  ...
  checkin: {
    ...
    description: 'Claim spirit stones every day and earn bonuses that repeat every 16 consecutive days.',
    ...
    day4Bonus: 'Consecutive Day 4 Bonus',
    day16Bonus: 'Consecutive Day 16 Bonus',
    nextBonus: 'Next Bonus',
    daysToBonus: '{days} days to the next bonus (cycle day {milestone})',
    noMoreBonus: 'All bonuses for this consecutive streak are claimed',
    ...
    ruleBonus4: 'On day 4 of each consecutive check-in cycle, you receive an extra {reward}.',
    ruleBonus16: 'On day 16 of each consecutive check-in cycle, you receive an extra {reward}.',
    ruleMonthReset: 'Consecutive check-ins can span calendar months. Each 16-day cycle starts over at day 1, and any missed day also resets the cycle.',
  ...
  modelMarket: {
    ...
    officialPrice: 'Channel list price',
    discount: 'Discount',
    test: 'Test',
    ...
    officialReference: 'Channel billing baseline',
    discountCompared: '{value} below the channel billing baseline',
    sort: {
      label: 'Sort models',
  ...
  admin: {
    ...
    users: {
      ...
      groupConfigHint: 'Configure group access and custom rates for {email}',
    ...
    groups: {
      ...
      form: {
        ...
        cacheHitTargetEnabledHint: 'Applies only to successfully completed OpenAI HTTP streaming Chat Completions/Responses requests; downstream usage and local billing share the same adjustment.',
        ...
        daysUnit: 'days',
        cacheHitTargetPercentHint: 'Defaults to a 90% target, ±0.50% tolerance, and a 1-day history half-life. Other protocols, non-streaming, WebSocket, compact, input_tokens, image, and video requests are unaffected.',
      ...
      subscription: {
        ...
        dailyLimit: 'Daily Limit (Spirit Stones)',
        weeklyLimit: 'Weekly Limit (Spirit Stones)',
        monthlyLimit: 'Monthly Limit (Spirit Stones)',
      ...
      imagePricing: {
		...
		responseFormatBase64: 'Base64',
		responseFormatURL: 'URL (stored locally for 24 hours)',
		responseFormatExplicitHint: 'An explicit response_format in the client request takes precedence.',
    ...
    channels: {
      ...
      form: {
        ...
        billingMode: 'Billing Mode',
        priceCurrency: 'List Price Currency',
        priceCurrencyUSD: 'US Dollar ($)',
        priceCurrencyCNY: 'Chinese Yuan (¥)',
        ...
        defaultVideoPrice: 'Default video price per second (fallback when no resolution tier matches)',
        ...
        addRule: 'Add Rule',
        noRulesConfigured: 'No custom account cost rules configured.',
        ruleName: 'Rule name (optional)',
        ruleGroups: 'Groups',
        ruleAccounts: 'Accounts',
        searchAccountPlaceholder: 'Search accounts...',
        ruleAccountsHint: 'Matches selected accounts or groups; matches nothing when both are empty.',
    ...
    riskControl: {
      ...
      inputDetailTitle: 'Input Details',
      inputDetailContent: 'Original Input (Redacted)',
      inputDetailExcerpt: 'Saved Input Excerpt',
      inputDetailRedactedHint: 'Shows the last user input text in this audit. Line breaks are preserved and sensitive information is redacted.',
      inputDetailUnavailableHint: 'The original input was not saved for this historical record or event. Only the saved excerpt is available; the full input cannot be recovered.',
      inputDetailTruncatedHint: 'The redacted input contains {count} characters. Only the first 65,536 characters were saved, so the content below is truncated.',
      inputDetailImagesHint: 'The input contains {count} images. Only the image count was saved; image URLs and image data were not stored.',
      inputDetailNoText: 'No input text is available for this record.',
      inputDetailAuditError: 'Audit Error',
      inputDetailLoadFailed: 'Failed to load input details. Please retry.',
    ...
    accounts: {
      ...
      dataActions: 'Data',
      toolActions: 'Tools',
      checkAllCodexAccounts: 'Check All Codex Accounts',
      checkingAllCodexAccounts: 'Checking Codex accounts...',
      checkAllCodexConfirm: 'Check token status for all OpenAI OAuth / Codex accounts? Invalid accounts will be marked as error.',
      checkAllCodexEmpty: 'No Codex accounts to check',
      checkAllCodexSuccess: 'Codex account check completed: {count} succeeded',
      checkAllCodexPartial: 'Codex account check completed: {success} succeeded, {failed} failed',
      checkAllCodexFailed: 'Failed to check Codex accounts',
      viewColumns: 'Columns',
      selectedCount: '{count} selected',
      ...
      dataImportHint: 'Upload Sub2API exports or multiple Codex Agent Identity auth.json files.',
      dataImportWarning: 'Do not mix both formats. Agent Identity duplicates are updated by ChatGPT account; bind groups after import.',
      dataImportFile: 'JSON files',
      ...
      dataImportInvalidFile: '{name} is not a supported Sub2API export or Agent Identity auth.json file',
      dataImportMixedFileTypes: 'Sub2API exports and Agent Identity auth.json files cannot be imported together. Import them separately.',
      ...
      agentIdentityImportResultSummary: 'Agent Identity created {created}, updated {updated}, skipped {skipped}, failed {failed}',
      agentIdentityImportWarning: 'Warning',
      agentIdentityImportSuccess: 'Agent Identity import completed: created {created}, updated {updated}, skipped {skipped}',
      agentIdentityImportCompletedWithErrors: 'Agent Identity import completed with errors: created {created}, updated {updated}, skipped {skipped}, failed {failed}',
      ...
      quotaLimitHint: 'Set daily/weekly/total spending limits (Spirit Stones). Anthropic API key accounts can also configure client affinity. Changing limits won\'t reset usage.',
      ...
      bulkEdit: {
        ...
        filteredScope: 'Current filter results',
        selectionInfo:
          'Updating {count} selected account(s). Only checked or filled fields will be updated; others stay unchanged.',
        filteredSelectionInfo:
          'Updating {count} account(s) in the current filter results, not just this page. Only checked or filled fields will be updated; others stay unchanged.',
        ...
        updateFiltered: 'Update Filter Results',
        updating: 'Updating...',
    ...
    settings: {
      ...
      features: {
        ...
        checkin: {
          ...
          dailyReward: 'Daily Reward',
          extraReward4: 'Consecutive Day 4 Bonus',
          extraReward16: 'Consecutive Day 16 Bonus',
          rewardHint: 'Rewards must be non-negative. When enabled, the daily reward must be greater than 0. Bonus rewards are issued on cycle days 4 and 16, repeating every 16 days; a missed day resets the cycle.',
      ...
      site: {
        ...
        apiBaseUrlHint:
          'Used for "Use Key", "Import to CC Switch", and callback URL suggestions. Prefer an HTTPS public URL reachable from the client machine; leave empty to use the current site URL. Re-import into CCS after changes.',
        ...
        quickLinkTitle: 'Header Quick Link',
        quickLinkDescription: 'Show a prominent external link in the signed-in header for support, announcements, or community access',
        quickLinkText: 'Link Text',
        quickLinkTextPlaceholder: 'Contact support: open aibang.click and save the URL',
        quickLinkTextHint: 'Recommended 8-40 characters. Long text is truncated in the header.',
        quickLinkUrl: 'Link URL',
        quickLinkUrlPlaceholder: 'https://aibang.click',
        quickLinkUrlHint: 'Must be an absolute http(s) URL. Opens in a new window.',
        quickLinkTextRequired: 'Link text is required when the header quick link is enabled',
        quickLinkUrlInvalid: 'Header quick link URL must be a valid http(s) URL',
        siteLogo: 'Site Logo',
      ...
      payment: {
        ...
        balanceRechargeMultiplierHint: 'How many Spirit Stones the user receives for each 1 CNY paid',
        balanceRechargePreview: 'Preview: 1 CNY = {usd} Spirit Stones',
        subscriptionUsdToCnyRate: 'Subscription CNY Conversion Rate',
        subscriptionUsdToCnyRateHint:
          'CNY charged per 1 Spirit Stone of plan price on CNY channels (e.g. 7.15). 0 or empty = disabled, plan price is charged as-is. When enabled, all plan prices must be set in Spirit Stones',
      ...
      openaiFastPolicy: {
        ...
        userIdsInvalid: 'User IDs must be unique safe integers greater than 0.',
        errorMessage: 'Error message',
        errorMessagePlaceholder: 'Custom error message when blocked',
  ...
  onboarding: {
    ...
    admin: {
      ...
      groupMultiplier: {
        ...
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">Set the billing multiplier to control user charges.</p><div style="padding: 8px 12px; background: #fef3c7; border-left: 3px solid #f59e0b; border-radius: 4px; font-size: 13px; margin-bottom: 12px;"><b>⚙️ Billing Rules:</b><ul style="margin: 8px 0 0 16px;"><li><b>1.0</b> - Original price (cost price)</li><li><b>1.5</b> - User consumes 1 Spirit Stone, charged 1.5 Spirit Stones</li><li><b>2.0</b> - User consumes 1 Spirit Stone, charged 2 Spirit Stones</li><li><b>0.8</b> - Subsidy mode (loss-making)</li></ul></div><p style="font-size: 13px; color: #6b7280;">Recommend setting test group to 1.0</p></div>',
        nextBtn: 'Next'
      },
      groupExclusive: {
  ...
  payment: {
    ...
    admin: {
      ...
      insufficientBalance: 'Insufficient balance — will deduct to 0 Spirit Stones',
