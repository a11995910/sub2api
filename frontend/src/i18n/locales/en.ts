export default {
  ...
  checkin: {
    ...
    description: 'Claim spirit stones every day and earn consecutive check-in bonuses.',
    ...
    daysToBonus: '{days} consecutive days to day {milestone}',
    ...
    ruleBonus4: 'On the 4th consecutive check-in day, you receive an extra {reward}.',
    ruleBonus16: 'On the 16th consecutive check-in day, you receive an extra {reward}.',
    ruleMonthReset: 'Consecutive check-ins can span calendar months and reset to day 1 after any missed day.',
    ...
    settings: {
      ...
      features: {
        ...
        checkin: {
          ...
          rewardHint: 'Rewards must be non-negative. When enabled, the daily reward must be greater than 0. Bonus rewards are issued on consecutive day 4 and day 16, and reset after a missed day.',
