  ...
  admin: {
    ...
    groups: {
      ...
      imagePricing: {
        ...
        selectImage4KEnhancementGroup: '选择图片分组',
        noImage4KEnhancementGroup: '不使用 4K 提升分组',
        image4KEnhancementGroupHint: '目标分组需为 OpenAI 图片分组；选择分组后还需选择二段提升使用的目标模型。',
        image4KEnhancementGroupRequired: '开启 4K 提升时必须选择目标图片分组',
