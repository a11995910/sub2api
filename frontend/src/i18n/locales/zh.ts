  ...
  admin: {
    ...
    groups: {
      ...
      form: {
        ...
        cacheHitTargetEnabledHint: '按用户和分组进行时间衰减累计；超过目标加容差后，把必要数量的缓存读取 Token 划为普通输入并回调到目标。',
        cacheHitTargetPercent: '目标命中率',
        cacheHitTargetTolerancePercent: '容差带',
        cacheHitHalfLifeDays: '历史半衰期',
        daysUnit: '天',
        cacheHitTargetPercentHint: '默认目标 90%、容差 ±0.50%、历史半衰期 1 天；历史权重每经过一个半衰期减半。真实上游缓存与响应不受影响。',
