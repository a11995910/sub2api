export default {
  ...
  checkin: {
    title: '每日签到',
    description: '每天领取灵石，连续签到可获得额外奖励。',
    ...
    nextBonus: '下一档额外奖励',
    daysToBonus: '还差 {days} 天连续签到到第 {milestone} 天',
    noMoreBonus: '当前连续周期的额外奖励已全部领取',
    currentBalance: '当前余额：{balance}',
    monthCalendar: '{year} 年 {month} 月签到表',
    rulesTitle: '签到规则',
    ruleDaily: '每日只能签到一次，签到成功后发放 {reward}。',
    ruleBonus4: '连续第 4 天签到时，额外发放 {reward}。',
    ruleBonus16: '连续第 16 天签到时，额外发放 {reward}。',
    ruleMonthReset: '连续签到可跨自然月累计，任意一天未签到后从第 1 天重新计算。',
    loadFailed: '加载签到信息失败',
    failed: '签到失败',
    ...
    settings: {
      ...
      features: {
        ...
        checkin: {
          ...
          rewardHint: '奖励必须为非负数；启用签到时每日固定奖励必须大于 0。额外奖励在连续第 4 天、第 16 天签到时发放，断签后重新计算。',
