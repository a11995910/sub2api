  ...
  admin: {
    ...
    groups: {
      ...
      form: {
        ...
        cacheHitTargetEnabledHint: '按用户和分组累计计算；仅在命中率将超过目标时，把本次必要数量的缓存读取 Token 划为普通输入，并按调整后的口径统计和计费。',
        cacheHitTargetPercent: '目标命中率上限',
        cacheHitTargetPercentHint: '可设置 0.01%–100%，默认 90%。低于目标时不会改动；真实上游缓存与响应不受影响。',
