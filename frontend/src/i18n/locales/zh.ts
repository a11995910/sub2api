  ...
  admin: {
    ...
    groups: {
      ...
      form: {
        ...
        cacheHitTargetEnabledHint: '按用户和分组累计计算；超过目标加容差后，把必要数量的缓存读取 Token 划为普通输入并回调到目标。',
        cacheHitTargetPercent: '目标命中率',
        cacheHitTargetTolerancePercent: '容差带',
        cacheHitTargetPercentHint: '默认目标 90%、容差 ±0.50%；即超过 90.50% 才触发并回调到 90%。真实上游缓存与响应不受影响。',
