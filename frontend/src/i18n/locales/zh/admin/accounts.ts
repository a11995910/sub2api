    ...
    accounts: {
      ...
      openai: {
        ...
        dynamic: {
          ...
          target: '每个模型的健康头数量', targetHint: '默认 4 个，范围 1–100；已保存账号保留原数量。使用中的健康头仍计入目标，剩余不足 10 分钟的空闲头提前补新。', targetPreset: '设为每模型 {count} 个', targetSummary: '已选 {models} 项，预计最多 {total} 个；相同实际模型共用库存。', maxAttempts: '每轮最多尝试入口数',
