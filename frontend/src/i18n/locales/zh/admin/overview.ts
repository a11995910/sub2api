export default {
    ...
    groups: {
      ...
      groupBaseRate: '分组基础倍率',
      promoGroupEffectiveRate: '分组活动倍率',
      userBaseRate: '专属基础倍率',
      promoEffectiveRate: '活动折后实际倍率',
      promoRateAppliedHint: '活动生效中：专属倍率按 {discount} 结算。活动时间：{window}。',
