export default {
    settings: {
      ...
      gatewayForwarding: {
        ...
        codexTicketHarvestModeHint: '仅用于门票采集，业务请求继续使用账号代理。切换来源会保留另一来源已保存的配置。',
        codexTicketHarvestProxy: '292 门票采集代理',
        codexTicketHarvestProxyDesc: '填写完整 HTTP(S) 或 SOCKS5(h) 代理 URL，出口 IP 轮换由代理服务商负责。留空或保留已隐藏的密码表示不修改。',
