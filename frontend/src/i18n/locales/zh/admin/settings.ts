    ...
    settings: {
      ...
      features: {
        ...
        modelPlaza: {
          ...
          usdToCnyRate: '模型广场美元兑人民币汇率',
          usdToCnyRateHint: '仅用于将 USD 渠道原价折算成人民币并计算模型广场优惠，不改变实际灵石扣费。',
          usdToCnyRateInvalid: '美元兑人民币汇率必须在 0.01 到 100 之间。',
      ...
      gatewayForwarding: {
        ...
        codexTicketEnabled: '292/332 门票总开关',
        codexTicketEnabledDesc: '仅对账号状态头策略选择“292/332 门票”的账号生效。开启后后台采集，并在业务请求中注入。',
        ...
        codexTicketHarvestMode: '292/332 门票采集来源',
        codexTicketHarvestModeProxy: '固定代理地址',
        codexTicketHarvestModeExtract: '批量 IP 提取接口',
        codexTicketHarvestModeHint: '成功门票与采集代理按账号、模型绑定，业务请求持续使用该代理，直到门票或出口失效。切换采集来源保留已有有效绑定。',
        codexTicketHarvestProxy: '292/332 门票采集代理',
        ...
        codexTicketHarvestExtractDesc: '支持 HTTP／HTTPS 提取接口，返回逐行 IP:PORT 或 BestGo JSON。后台提取一批代理后按顺序尝试，取得有效门票即停止本目标尝试。全局最多同时采集 4 个账号模型，失败后等待下一轮。进度可在账号的 292/332 门票状态中查看。',
