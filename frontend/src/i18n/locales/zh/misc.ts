export default {
  ...
  version: {
    ...
    dockerModeHint: 'Docker 部署请拉取并切换镜像版本，不能在容器内覆盖程序',
    updateNow: '立即更新',
    updating: '正在更新...',
    updateComplete: '更新完成',
    updateFailed: '更新失败',
    ...
    rollbackDockerWarning: 'Docker 部署必须通过 compose 切换镜像版本，容器内不执行在线回退',
    rollingBack: '正在回退...',
    ...
    rollbackDockerHint: 'Docker 部署不支持容器内在线回退，请按部署文档切换到上一版镜像 tag',
    deployScript: '脚本部署',
    deployDocker: 'Docker',
