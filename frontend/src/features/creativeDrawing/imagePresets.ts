 ...
 * 创意绘图首页预设。
 *
 * 文案与图片资产改写自 ZyphrZero/chatgpt2api（MIT License，Copyright (c) 2026 kunkun），
 * 用于复刻创作台的快速开局体验。
 */
