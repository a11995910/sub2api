...
export interface Account {
  ...
  codex_turn_tickets?: OpenAICodexTicketStatus[]
  ...
  anthropic_forwarding_risk?: AnthropicForwardingRisk | null
...
export interface AnthropicForwardingRisk {
  level: 'medium' | 'high'
  summary: string
  reasons: string[]
}
...
export interface UsageLog {
  ...
  upstream_response_service_tier?: string | null
