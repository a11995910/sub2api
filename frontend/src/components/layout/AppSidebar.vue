...
function buildSelfNavItems(withDashboard: boolean): NavItem[] {
  ...
  items.push(
    ...
    // 定制购买页位于 /payment；/purchase 保留为兑换码页的历史别名。
    { path: '/payment', label: purchaseNavLabel.value, icon: RechargeSubscriptionIcon, hideInSimpleMode: true, featureFlag: flagPayment },
...
const adminNavItems = computed((): NavItem[] => {
  const baseItems: NavItem[] = [
    ...
    { path: '/admin/lottery', label: t('nav.lotteryManagement'), icon: GiftIcon, hideInSimpleMode: true, featureFlag: flagLottery },
    ...
    { path: '/admin/video-task-reviews', label: t('nav.videoTaskReviews'), icon: SignalIcon },
