    ...
    >
      <div class="collapsible-inner">
        ...
        <div v-if="entry.billing_mode === 'token'">
          ...
          <div v-if="enableServiceTierMultipliers" class="mt-3 grid max-w-2xl grid-cols-1 gap-2 sm:grid-cols-2">
            <div>
...
import { getPlatformTagClass, perTokenToMTok, pricingInputToForm, transitionPricingBillingMode, isValidPositiveMultiplier, validateReasoningEffortMultipliers } from './types'
