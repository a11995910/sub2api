...
describe('admin order currency display', () => {
  it('uses order currency for paid/base/fee amounts and spirit stones for credited/refund amounts', () => {
    ...
    expect(text).toContain('100.00 灵石')
    expect(text).toContain('25.00 灵石')
  })

  it('uses order currency for pay_amount and spirit stones for refundable balance amounts', () => {
    ...
    expect(text).toContain('$108.00')
    expect(text).toContain('100.00 灵石')
    expect(text).toContain('20.00 灵石')
    expect(text).toContain('80.00 灵石')
    expect(text).toContain('200.00 灵石')
  })
