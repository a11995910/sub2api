...
function generateOpenAIFiles(baseUrl: string, apiKey: string): FileConfig[] {
  ...
  const selectedDescriptor = findCodexCatalogModel(codexModelManifestContent.value, model)
  const reasoningEffortLine = selectedDescriptor
    ? codexReasoningEffortTomlLine(model)
