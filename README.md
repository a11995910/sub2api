...
The repository does not embed Antigravity Google OAuth credentials. Before using the Antigravity OAuth login flow, inject `ANTIGRAVITY_OAUTH_CLIENT_ID` and `ANTIGRAVITY_OAUTH_CLIENT_SECRET` in the runtime environment.
